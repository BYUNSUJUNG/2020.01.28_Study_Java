	...
	public static void main(String[] args) {
		...
		while(moveCount!=10) {
			...
			if(moveCount%2==1) {
				...
				if(inputFloor>MAX_FLOOR) {
					System.out.print("가장 높은 층은 10층입니다.");
					inputFloor=10;
				} else if(inputFloor<MIN_FLOOR) {
					System.out.print("가장 낮은 층은 1층입니다.");
					inputFloor=1;
				}
				...
				if(callFloor>MAX_FLOOR) {
					// System.out.print("가장 높은 층은 10층입니다.");
					callFloor=10;
				} else if(callFloor<MIN_FLOOR) {
					// System.out.print("가장 낮은 층은 1층입니다.");
					callFloor=1;
				}
